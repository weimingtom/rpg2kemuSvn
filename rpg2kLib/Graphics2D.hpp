...
namespace rpg2kLib
{
	...
	#define PP_allImageType(func) func(bmp) func(png) func(xyz)
	class Graphics2D
	{
	public:
	...
	protected:
		...
		Image& loadImage(Material::Type type, RPG2kString const& name, bool trans) const;
